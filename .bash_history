...
ls
rm TesttodoListApi/
rmdir TesttodoListApi/
rm -r TesttodoListApi/
ls
mkdir testing
cd testing
lb
...
pm install --save loopback-connector-mongodb
...
cd server
ls
sudo nano model-config.json
cd ..
ls
cd server
ls
sudo nano config.json
sudo nano middleware.json
cd ..
ls
cd server
ls
...
npm run start
ls
sudo nano component-config.json
sudo nano model-config.json
cd ..
ls
cd ..
